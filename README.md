...
## Repository
**GitHub Link:** [https://github.com/Ikshuka/ITPM_ASSIGNMENT_01.git](https://github.com/Ikshuka/ITPM_ASSIGNMENT_01.git)
...
2. **Execute Automation**:
   ...
   `python it23779402_test_automation.py --excel "it23779402_Test cases.xlsx" --url "https://www.pixelssuite.com/chat-translator"`
